...
class PolyInterPol(_InterPol):
    ...
    The number of data points_1 determines the degree of the polynomial.
    """
    def __init__(self, x_data, y_data, method="newton"):
        """
        Initialize.
        Params:
        - x_data    x-coordinates of data points_1 (as list or Numpy array)
        - y_data    y-coordinates of data points_1 (as list or Numpy array)
...
class _CurveFit:
    ...
    def plot(self, x_title='x', y_title='y'):
        """
